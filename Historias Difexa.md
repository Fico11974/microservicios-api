...
[H03: Gestión de usuarios por administrador	5](#h03:-gestión-de-usuarios-por-administrador-\(riera-julián\))

[Criterios de aceptación	5](#criterios-de-aceptación-3)

[H03b: Gestión de sesiones activas	6](#h03b:-gestión-de-sesiones-activas-\(riera-julian\))

[Criterios de aceptación	6](#criterios-de-aceptación-4)

[H03c: Gestión de notificaciones del sistema 	6](#h03c:-gestión-de-notificaciones-del-sistema-\(riera-julián\))
...
[H10: Edición de publicación	10](#h10:-edición-de-publicación-\(ramiro-platero\))

[Criterios de aceptación	10](#criterios-de-aceptación-12)

[H10b: Historial y versionado de publicaciones	11](#h10b:-historial-y-versionado-de-publicaciones-\(ramiro-platero\))
...
[H11b: Búsqueda y filtrado de publicaciones	12](#h11b:-búsqueda-y-filtrado-de-publicaciones\(alang\))

[Criterios de aceptación	12](#criterios-de-aceptación-15)

[H11c: Gestión de archivos adjuntos	13](#h11c:-gestión-de-archivos-adjuntos-\(gino-martin\))

[Criterios de aceptación	13](#criterios-de-aceptación-16)

[H12: Archivado de publicación	14](#h12:-archivado-de-publicación-\(federico\))
...
[H13: Solicitud de enriquecimiento por IA	14](#h13:-solicitud-de-enriquecimiento-por-ia-\(carlos\))

[Criterios de aceptación	15](#criterios-de-aceptación-18)

[H14: Revisión de contenido enriquecido	16](#h14:-revisión-de-contenido-enriquecido\(nicolas-neira\))

[Criterios de aceptación	16](#criterios-de-aceptación-19)

[**Módulo de Moderación	16**](#módulo-de-moderación)

[H15: Aprobación de publicaciones por moderador	16](#h15:-aprobación-de-publicaciones-por-moderador\(nicolas-neira\))

[Criterios de aceptación	16](#criterios-de-aceptación-20)

[H16: Detención de publicación en difusión	17](#h16:-detención-de-publicación-en-difusión\(alang\))
...
[H17: Programación de publicaciones	17](#h17:-programación-de-publicaciones-\(sol\))

[Criterios de aceptación	17](#criterios-de-aceptación-22)

[H18: Difusión manual de contenido	17](#h18:-difusión-manual-de-contenido-\(matias\))

[Criterios de aceptación	17](#criterios-de-aceptación-23)

[H19: Consumo de publicaciones por difusores	17](#h19:-consumo-de-publicaciones-por-difusores-\(matias\))

[Criterios de aceptación	18](#criterios-de-aceptación-24)

[H20: Consulta de publicaciones para dispositivos cliente	18](#h20:-consulta-de-publicaciones-para-dispositivos-cliente-\(matias\))

[Criterios de aceptación	18](#criterios-de-aceptación-25)

[**Módulo de Seguridad y Permisos	18**](#módulo-de-seguridad-y-permisos)

[H21: Gestión de permisos por rol	18](#h21:-gestión-de-permisos-por-rol-\(javier\))

[Criterios de aceptación	18](#criterios-de-aceptación-26)

[H22: Cierre de sesión	18](#h22:-cierre-de-sesión-\(javier\))

[Criterios de aceptación	19](#criterios-de-aceptación-27)

[**Módulo de Gestión de Perfil	19**](#módulo-de-gestión-de-perfil)

[H23: Gestión de contexto semántico del usuario	19](#h23:-gestión-de-contexto-semántico-del-usuario-\(javier\))

[Criterios de aceptación	19](#criterios-de-aceptación-28)

[H24: Modificación de datos del perfil	19](#h24:-modificación-de-datos-del-perfil-\(gino-martin\))

[Criterios de aceptación	19](#criterios-de-aceptación-29)

[H25: Cambio de contraseña	19](#h25:-cambio-de-contraseña\(enzo\))

[Criterios de aceptación	19](#criterios-de-aceptación-30)

[H26: Cambio de correo electrónico	20](#h26:-cambio-de-correo-electrónico\(enzo\))

[Criterios de aceptación	20](#criterios-de-aceptación-31)

[H27: Eliminación de cuenta	20](#h27:-eliminación-de-cuenta\(ismael\))

[Criterios de aceptación	20](#criterios-de-aceptación-32)

[**Módulo de Reportes y Analíticas	20**](#módulo-de-reportes-y-analíticas)

[H28: Reportes y estadísticas del sistema	20](#h28:-reportes-y-estadísticas-del-sistema\(ismael\))

[Criterios de aceptación	21](#criterios-de-aceptación-33)

[H29: Auditoría y logs del sistema	22](#h29:-auditoría-y-logs-del-sistema-\(platero-fabrizio\))
...
[H30: Configuración general del sistema	23](#h30:-configuración-general-del-sistema-\(ramiro-platero\))
...
## **H03: Gestión de usuarios por administrador (Riera Julián)** {#h03:-gestión-de-usuarios-por-administrador-(riera-julián)}
...
## **H03b: Gestión de sesiones activas (Riera Julian)** {#h03b:-gestión-de-sesiones-activas-(riera-julian)}
...
## **H03c: Gestión de notificaciones del sistema (Riera Julián)** {#h03c:-gestión-de-notificaciones-del-sistema-(riera-julián)}
...
## **H10: Edición de publicación (Ramiro Platero)** {#h10:-edición-de-publicación-(ramiro-platero)}
...
## **H10b: Historial y versionado de publicaciones (Ramiro Platero)** {#h10b:-historial-y-versionado-de-publicaciones-(ramiro-platero)}
...
## **H11b: Búsqueda y filtrado de publicaciones(AlanG)** {#h11b:-búsqueda-y-filtrado-de-publicaciones(alang)}
...
## **H12: Archivado de publicación (federico)** {#h12:-archivado-de-publicación-(federico)}
...
## **H13: Solicitud de enriquecimiento por IA (carlos)** {#h13:-solicitud-de-enriquecimiento-por-ia-(carlos)}
...
## **H14: Revisión de contenido enriquecido(Nicolas Neira)** {#h14:-revisión-de-contenido-enriquecido(nicolas-neira)}
...
## **H15: Aprobación de publicaciones por moderador(Nicolas Neira)** {#h15:-aprobación-de-publicaciones-por-moderador(nicolas-neira)}
...
## **H16: Detención de publicación en difusión(AlanG)** {#h16:-detención-de-publicación-en-difusión(alang)}
...
## **H17: Programación de publicaciones (Sol)** {#h17:-programación-de-publicaciones-(sol)}
...
## **H18: Difusión manual de contenido (Matias)** {#h18:-difusión-manual-de-contenido-(matias)}
...
## **H19: Consumo de publicaciones por difusores (Matias)** {#h19:-consumo-de-publicaciones-por-difusores-(matias)}
...
## **H20: Consulta de publicaciones para dispositivos cliente (Matias)** {#h20:-consulta-de-publicaciones-para-dispositivos-cliente-(matias)}
...
## **H21: Gestión de permisos por rol (javier)** {#h21:-gestión-de-permisos-por-rol-(javier)}
...
## **H22: Cierre de sesión (javier)** {#h22:-cierre-de-sesión-(javier)}
...
## **H23: Gestión de contexto semántico del usuario (javier)** {#h23:-gestión-de-contexto-semántico-del-usuario-(javier)}
...
## **H24: Modificación de datos del perfil (Gino Martin)** {#h24:-modificación-de-datos-del-perfil-(gino-martin)}
...
## **H25: Cambio de contraseña(enzo)** {#h25:-cambio-de-contraseña(enzo)}
...
## **H26: Cambio de correo electrónico(enzo)** {#h26:-cambio-de-correo-electrónico(enzo)}
...
## **H27: Eliminación de cuenta(Ismael)** {#h27:-eliminación-de-cuenta(ismael)}
...
POST /api/profile/email/change/verify/{token}

# **Módulo de Reportes y Analíticas** {#módulo-de-reportes-y-analíticas}

## **H28: Reportes y estadísticas del sistema(Ismael)** {#h28:-reportes-y-estadísticas-del-sistema(ismael)}
...
## **H29: Auditoría y logs del sistema (Platero Fabrizio)** {#h29:-auditoría-y-logs-del-sistema-(platero-fabrizio)}
...
## **H30: Configuración general del sistema (Ramiro Platero)** {#h30:-configuración-general-del-sistema-(ramiro-platero)}
